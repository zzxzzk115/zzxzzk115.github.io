          ...
          {%- unless child.title == 'divider' -%}
            {
              ...
              {%- if child.permalink contains "/featured-posts/" -%}{%- assign url = "/featured-posts/" -%} {%- else -%}{%- assign url = child.permalink -%}{%- endif -%}
      ...
      {%- else -%}
        {
          ...
          {%- if p.permalink contains "/featured-posts/" -%}{%- assign url = "/featured-posts/" -%} {%- else -%}{%- assign url = p.url -%}{%- endif -%}
